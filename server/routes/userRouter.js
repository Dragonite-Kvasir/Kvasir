...
router.patch('/update/name', userController.getId, userController.updateName, (req, res) => {
...
router.patch('/update/teach', userController.getId, userController.updateTeach, (req, res) => {
    return res.send('two thumbs up!');
});

router.patch('/update/learn', userController.getId, userController.updateLearn, (req, res) => {
    return res.send('two thumbs up!');
});
